...
import indivial from '../assets/bg/indivial.jpg';
import Team from '../assets/bg/team.jpg';
...
export const Contact = () => {
  ...
  const navigate = useNavigate(); 
   ...
   const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      'service_qkc5jib', // ⚠️ replace
      'template_b2je03m', // ⚠️ replace
      form.current,
      'IE9LuvXJ12kt_sTsD' // ⚠️ replace
    )
    .then(
      (result) => {
  ...
  return (
    <>
    <section className="relative w-full py-24 bg-white/70 dark:bg-gradient-to-b dark:from-black dark:via-gray-900 dark:to-gray-950 px-6">
      <div className="relative z-10 max-w-7xl mx-auto space-y-12">

        {/* Heading */}
        <motion.h2 
          data-aos="fade-up"
          className="text-4xl md:text-5xl font-bold dark:text-white text-center"
        >
        ...
        <motion.p 
          data-aos="fade-up"
          data-aos-delay="100"
          className="text-gray-500 max-w-2xl mx-auto text-center text-lg"
        >
        ...
        <div className="relative z-10  w-full">
          <div className="bg-white/5 backdrop-blur-md dark:bg-gray-950 dark:text-gray-100 rounded-lg shadow-2xl overflow-hidden flex  w-full">

            {/* Left Side Form */}
            <div className="lg:w-1/2 w-full p-8 space-y-6 bg-white/40 dark:bg-white/10">
            ...
            <div className="lg:w-1/2 relative overflow-hidden">
              <img src={indivial} alt="Contact Individual" className={`absolute top-0 left-0 h-full w-full object-cover transition-all duration-700 transform ${selectedType === 'company' ? '-translate-x-full opacity-0' : 'translate-x-0 opacity-100'}`} />
              <img src={Team} alt="Contact Company" className={`absolute top-0 left-0 h-full w-full object-cover transition-all duration-700 transform ${selectedType === 'company' ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'}`} />

              <div className="absolute inset-0 bg-black/60 blur-lg hover:bg-black/0 group-hover:backdrop-blur-0 transition-all duration-500"></div>
